        ...
        <td>
        	<%
        		if(session.getAttribute("logid")==null){
        			...
        			String a1=(String)request.getAttribute("alreadylogin");
        			out.println(a1);
        		}
        		else if(request.getAttribute("alreadyloginre")!=null){
        			String a1=(String)request.getAttribute("alreadyloginre");
        			out.println(a1);
        		}
        	%>
        </td>
